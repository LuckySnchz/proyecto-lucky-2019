...
if ( isset($_SESSION["usuarioLogueado"]) == false ) {
  ...
  $avatarDefaultEdicion=$usuario["avatar"];
	...
	if ( $_POST ) {
		$errores = validarEdicionContrasenia();
		...
		if ( count($errores) == 0 ) {
			...
			$usuario =actualizarUsuarioPorEmailContrasenia($_SESSION["usuarioLogueado"],$_POST["password"]);
		...
		<img src="avatars/<?=$usuario["avatar"]?>" style="width:100px;margin-left: 36%;border-radius:50%"><br><br>
                ...
                <div class="row">
                    <div class="col-md-3 register-left">
                            	...
                            	<form action="miPerfilContraseña.php" method="POST">

                         												<div class="form-group">
																				 			 																		 <ul style="color:red; ">
																				 			 																		<?php if (isset($errores["passwordold"])) : ?>
																				 			 									<input style="border: 1px solid red;" type="password" class="form-control" placeholder="Contasenia Actual *" value="" name="passwordold" style="width:100%; margin-left:20%" />
																				 			 																			<p style="color:red;font-size:8px;">
																				 			 																				<li><?=$errores["passwordold"]?></li>
																				 			 																			</p>
																				 			 																		<?php else : ?>
																				 			 																			<input type="password" class="form-control" placeholder="Contasenia Actual *" value="" name="passwordold"style="width:100%; margin-left:20%" />
																				 			 																		<?php endif; ?>
																				 			 																		</ul>
																				 			 							            </div>
																																									<div class="form-group">
																																 ...
																																 <input style="border: 1px solid red;" type="password" class="form-control" placeholder="Nueva Contasenia *" value="" name="password" style="width:100%; margin-left:20%"/>
																																										 <p style="color:red;font-size:8px;">
																																											 <li><?=$errores["password"]?></li>
																																										 </p>
																																									 <?php else : ?>
																																										 <input type="password" class="form-control" placeholder="Nueva Contrasenia *" value="" name="password" style="width:100%; margin-left:20%" />
																																									 <?php endif; ?>
																																									 </ul>
																														 </div>
																						 ...
																						 <input style="border: 1px solid red;" type="password" class="form-control" placeholder="Confirmar Nueva Contasenia *" value="" name="cpassword"style="width:100%; margin-left:20%"/>
																																 <p style="color:red;font-size:8px;">
																																	 <li><?=$errores["cpassword"]?></li>
																																 </p>
																															 <?php else : ?>
																																 <input type="password" class="form-control" placeholder="Confirmar Nueva Contasenia *" value="" name="cpassword" style="width:100%; margin-left:20%" />
																															 <?php endif; ?>
																															 </ul>
																				 </div>
                                      ...
                                      <input type="submit" class="btnRegister"  value="Guardar" style="width:85%;background-color:grey;margin-left:31%;border-radius:10%"/>
                                      </form>
                                      </div>

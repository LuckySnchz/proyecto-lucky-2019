...
$articulo1 = [
	"id" => 1,
	"nombre" => "cicatricure",
	"descripcion" => "<br>Crema<br>corporal<br>",
	"imagen" => "cicatricure.png",
...
<html>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
   ...
   <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
	...
	<header>
		...
		<div class="btn-group" style="width:36%;height: 8vh;font-size:18px;margin-left:1%;margin-bottom:-0.5%;margin-top:-1%">
			...
			<div class="dropdown-menu" style="padding:8.5%;margin-top:2%"  style="width:43%;height: 10vh;margin-top:2%">
				<a  href="index.php">Protectore Solares</a><br>
				<a  href="asepxia.php">Asepxia</a><br>
				<a  href="citatricure.php">Cicatricure</a><br>
	...
	<body>
  <form class="" action="cicatricure.php" method="POST">
<div class="columnas">
